...
public class dlgBuscarContrato extends javax.swing.JDialog {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(dlgBuscarContrato.class.getName());

    public dlgBuscarContrato(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Buscar Contrato");
        ...
        tblContratos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Numero Contrato", "Cedula", "Placa", "Fecha de Inicio", "Fecha de Finalizacion", "Monto", "Estado"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                dlgBuscarContrato dialog = new dlgBuscarContrato(new javax.swing.JFrame(), true);
